...
class BookableUpdateRequest extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     */
    public function authorize(BookableService $service): bool
    {
        if (Gate::authorize('edit', $service->bookable($this->route('bookable')))) {
            return true;
        }
        return false;
    }
