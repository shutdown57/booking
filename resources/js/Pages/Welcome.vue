...
<template>
    ...
    <h1 class="my-3 text-6xl text-center">
        Booking Tennis Courts and Snooker Tables
    </h1>

    <section class="container mx-auto">
        <div class="flex flex-row w-full justify-between h-screen">
            <div class="basis-1/2">
                <h3 class="text-xl">Available Tennis Courts</h3>
                Table
            </div>

            <div class="basis-1/2">
                <h3 class="text-xl">Available Snooker Tables</h3>
                Table
            </div>
        </div>
    </section>
    ...
    <!---->
    <!--                         <div -->
    <!--                             class="flex relative gap-6 items-center lg:items-end" -->
    <!--                         > -->
    <!--                             <div -->
